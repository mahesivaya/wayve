...
OpenAPI 3.1-aware generator at `https://rwayve.maheshg.me/api/openapi.json`:

```bash
# TypeScript / fetch
npx @hey-api/openapi-ts -i https://rwayve.maheshg.me/api/openapi.json -o ./wayve

# Python / httpx
openapi-python-client generate --url https://rwayve.maheshg.me/api/openapi.json

# Go
oapi-codegen -package wayve https://rwayve.maheshg.me/api/openapi.json > wayve.gen.go
```
