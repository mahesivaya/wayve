...
OpenAPI 3.1-aware generator at `https://fluxze.com/api/openapi.json`:

```bash
# TypeScript / fetch
npx @hey-api/openapi-ts -i https://fluxze.com/api/openapi.json -o ./wayve

# Python / httpx
openapi-python-client generate --url https://fluxze.com/api/openapi.json

# Go
oapi-codegen -package wayve https://fluxze.com/api/openapi.json > wayve.gen.go
```
...
```bash
curl https://fluxze.com/api/webhooks \
