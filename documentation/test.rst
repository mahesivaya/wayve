...
DATABASE_URL=postgres://wayve_user:wayve_password@localhost:5432/wayve_dev
...
AES_HKDF_SALT=change-me-generate-with-openssl-rand-hex-32
...
# personal Outlook.com account. This removes the work-vs-personal account
# picker entirely. Use /common instead if you also need org mailboxes.
MICROSOFT_AUTHORITY=https://login.microsoftonline.com/consumers

SMTP_HOST=localhost
SMTP_PORT=1025
SMTP_USER=dev@example.local
SMTP_PASS=dev
...
POSTGRES_DB=wayve_dev
POSTGRES_USER=wayve_user
POSTGRES_PASSWORD=wayve_password
POSTGRES_PORT=5432
...
value: fmB8Q~dShW~JQjUSzmNGrGRt3.f~phTHKToDjdfe
secret ID: b68a5339-2d84-49bd-a04e-929a4f3f0720
...
:
caa20618-d806-4adb-81b1-5285a28dbc92
Object ID
:
f14898af-d910-4b2f-88e2-fcc2ce4383a1
Directory (tenant) ID
:
7a44ef5c-9dba-441a-9d18-b50db
